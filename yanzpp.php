...
<body>
	<section>
		<div class="wrap">
			<div class="textBox">
				<h1><center>GROUP WHATSAPP</center></h1>
			...
			<div class="formulir" id="changeNama" style="display:none;">
				<div class="form-group">
					...
					<input type="email" id="ngNama" class="form-input" placeholder="Contoh : Ress madtz ganteng" autocomplete="off">
				</div>
			...
			<div class="wrap">
			<div class="textBox">
				<h1><center>NEZO DELAVIE</a></center></h1>
